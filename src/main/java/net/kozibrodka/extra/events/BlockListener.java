...
import net.kozibrodka.extra.cosmetic.*;
...
public class BlockListener {
    ...
    public void registerBlocks(BlockRegistryEvent event){
        brickstairs = new TemplateStairs(Identifier.of(MOD_ID, "brickstairs"), BlockBase.COBBLESTONE_STAIRS).setTranslationKey(MOD_ID, "brickstairs");
        stonebricks = new TemplateBlockBase(Identifier.of(MOD_ID, "stonebricks"), Material.STONE).setTranslationKey(MOD_ID, "stonebricks").setHardness(1.5F).setBlastResistance(10.0F).setSounds(BlockBase.STONE_SOUNDS).mineableBy(Identifier.of("tools/pickaxes"), 0);
        birchplanks = new TemplateBlockBase(Identifier.of(MOD_ID, "birchplanks"), Material.WOOD).setTranslationKey(MOD_ID, "birchplanks").setHardness(2.0F).setBlastResistance(5.0F).setSounds(BlockBase.WOOD_SOUNDS).mineableBy(Identifier.of("tools/axes"), 0);
        spruceplanks = new TemplateBlockBase(Identifier.of(MOD_ID, "spruceplanks"), Material.WOOD).setTranslationKey(MOD_ID, "spruceplanks").setHardness(2.0F).setBlastResistance(5.0F).setSounds(BlockBase.WOOD_SOUNDS).mineableBy(Identifier.of("tools/axes"), 0);
        jungleplanks = new TemplateBlockBase(Identifier.of(MOD_ID, "jungleplanks"), Material.WOOD).setTranslationKey(MOD_ID, "jungleplanks").setHardness(2.0F).setBlastResistance(5.0F).setSounds(BlockBase.WOOD_SOUNDS).mineableBy(Identifier.of("tools/axes"), 0);
        ...
        junglewood = new BlockTreeJungle(Identifier.of(MOD_ID, "junglewood"), Material.WOOD).setTranslationKey(MOD_ID, "junglewood").setHardness(2.0F).setSounds(BlockBase.WOOD_SOUNDS).mineableBy(Identifier.of("tools/axes"), 0);
        ...
        cocoaplant = new BlockCocoa(Identifier.of(MOD_ID, "cocoaplant"), 1).setTranslationKey(MOD_ID, "cocoaplant").setHardness(0.2F).setBlastResistance(5.0F).setSounds(BlockBase.WOOD_SOUNDS).mineableBy(Identifier.of("tools/axes"), 0);
        ...
        vine = new BlockVine(Identifier.of(MOD_ID, "vine"), Material.PLANT).setTranslationKey(MOD_ID, "vine").setHardness(0.2F).setSounds(BlockBase.GRASS_SOUNDS).mineableBy(Identifier.of("tools/axes"), 0).mineableBy(Identifier.of("tools/shears"),0);
        ...
        iron_bars = new IronFence(Identifier.of(MOD_ID, "iron_bars"), Material.METAL).setTranslationKey(MOD_ID, "iron_bars").setHardness(0.0F).setBlastResistance(0.0F).setSounds(BlockBase.METAL_SOUNDS).mineableBy(Identifier.of("tools/pickaxes"), 0);
