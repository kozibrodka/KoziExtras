...
public class PaneTintedGlass extends TemplateBlockBase {
    ...
    public final boolean canConnect(int i)
    {
        ...
        if(kloc instanceof PaneGlass || kloc instanceof TintedGlass || kloc instanceof PaneTintedGlass || kloc instanceof PaneCross || kloc instanceof PaneTintedCross || i == Block.GLASS.id || Block.BLOCKS_OPAQUE[i])
        {
            flag1 = true;
        }
        return flag1;
