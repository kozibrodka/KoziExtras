...
public class PaneTintedGlass extends TemplateBlockBase {
    public PaneTintedGlass(Identifier identifier, Material material) {
    ...
    public final boolean canConnect(int i)
    {
        ...
        if(kloc instanceof PaneGlass || kloc instanceof TintedGlass || kloc instanceof PaneTintedGlass || kloc instanceof PaneCross || kloc instanceof PaneTintedCross || i == BlockBase.GLASS.id || BlockBase.FULL_OPAQUE[i])
        {
            flag1 = true;
        }
        return flag1;
